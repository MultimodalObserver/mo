...
public class ConfigDialog extends JDialog implements DocumentListener {
    ...
    public ConfigDialog(ProjectOrganization organization) {
        super(null, "Fixation Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
    }
