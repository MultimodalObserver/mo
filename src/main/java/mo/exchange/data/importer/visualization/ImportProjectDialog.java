...
public class ImportProjectDialog
{
	...
	private ExchangeableDataTree tree;
	...
	public ImportProjectDialog() {
        ...
        tree = new ExchangeableDataTree();
        tree.addExchangeableDataChangeEventListener(new ExchangeableDataTree.ExchangeableDataChangeEventListener() {
            @Override
    ...
    public List<ExchangeableData> getData() {
        return data;
    }
