...
import mo.core.filemanagement.project.NewProjectWizardPanel;
import java.io.File;
...
public class ExportProjectWizardPanel extends JPanel {
    WizardDialog wizard;
    ...
    public ExportProjectWizardPanel(WizardDialog wizard) {
        this.wizard = wizard;
        inter = new I18n(NewProjectWizardPanel.class);
        super.setName("Establecer el directorio raiz");
